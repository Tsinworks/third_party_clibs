...
typedef struct {
	...
	int conn_type; /**< The connection type. Currently 1 for usbmuxd, 2 for android debug bridge. */
} idevice_event_t;
...
*/
LIBIMOBILEDEVICE_API_MSC enum idevice_type idevice_get_type(idevice_t device);
